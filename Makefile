...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	 ft_isprint.c ft_itoa.c ft_lstnew.c ft_memalloc.c \
	 ...
	 ft_isminint.c ft_ismaxint.c ft_ismaxlong.c ft_sqrt.c ft_square.c

OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
		ft_isprint.o ft_itoa.o ft_lstnew.o \
		...
		ft_isminint.o ft_ismaxint.o ft_ismaxlong.o ft_sqrt.o ft_square.o
